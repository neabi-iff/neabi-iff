...
urlpatterns = patterns('',
                       ...
                       url(r'^projeto/(?P<slug_projeto>[-_\w]+)/acervo/(?P<slug>[-_\w]+)/serie/$', SerieList.as_view(),
                          name='serie-list'),
                       url(r'^projeto/(?P<slug_projeto>[-_\w]+)/acervo/(?P<slug_fundo>[-_\w]+)/serie/(?P<slug>[-_\w]+)/documento/$', DocumentoList.as_view(),
                          name='documento-list'),
                       url(r'^projeto/$', ProjetoList.as_view(), name='projeto_list'),
                       url(r'^projeto/(?P<slug>[-_\w]+)/acervo/$', FundoDetail.as_view(),
                          name='fundo_detail'),
                       url(r'^projeto/(?P<slug>[-_\w]+)/$', ProjetoDetail.as_view(),
                          name='projeto_detail'),
